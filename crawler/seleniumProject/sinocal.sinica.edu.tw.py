...
empReigns = [
             ...
             {'dyna': '西魏', 'king': '文帝', 'reign': '大統'},
               {'dyna': '西魏', 'king': '廢帝', 'reign': ''},
               {'dyna': '西魏', 'king': '恭帝', 'reign': ''},
            ...
            {'dyna': '元', 'king': '太祖', 'reign': ''},
            {'dyna': '元', 'king': '皇子拖雷', 'reign': ''},
            {'dyna': '元', 'king': '太宗', 'reign': ''},
            {'dyna': '元', 'king': '乃馬真后', 'reign': ''},
            {'dyna': '元', 'king': '定宗', 'reign': ''},
            {'dyna': '元', 'king': '海迷失后', 'reign': ''},
            {'dyna': '元', 'king': '憲宗', 'reign': ''},
...
def parse_sinocal():
    ...
    for item in empReigns:
        ele = driver.find_element_by_name("dyna")
        ele.click()
        Select(ele).select_by_value(item['dyna']) # 选中"西漢"
        if not item['king']=='':

            ele = driver.find_element_by_name("king")
            ele.click()
            Select(ele).select_by_value(item['king']) # 选中"西漢"

        if not item['reign']=='':
            ele = driver.find_element_by_name("reign")
            ele.click()
            Select(ele).select_by_value(item['reign']) # 选中"西漢"
        ...
        title=item['dyna']+'_'+item['king']+'_'+item['reign']
        file_path="D:\\CalendarDate\\"+title+".html"
